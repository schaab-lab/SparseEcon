...
AZ = FD_operator(G, agg.muZ(agg.agg2full, :), agg.sigZ(agg.agg2full, :), 2, '1');
AK = FD_operator(G, agg.muK(agg.agg2full, :), agg.sigK(agg.agg2full, :), 3, '1');
...
A = blkdiag(Aa{1} + AZ + AK, Aa{2} + AZ + AK) + Az;
