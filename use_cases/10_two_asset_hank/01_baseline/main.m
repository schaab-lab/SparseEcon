...
% Current version: June 2022. First version: August 2019.
% 
...
%  2. Schaab, A. Micro and Macro Uncertainty. Working Paper.
% Thanks!
% 
%------------------------------------------------------------------------%
...
param = define_parameters('add_tol', 5e-5, 'keep_tol', 1e-5, 'max_adapt_iter', 5, 'kappa', 60, ...
