...
% Grid construction:
param.l = 0; param.surplus = [3, 3, 3];
param.d = 3; param.d_idio = 3; param.d_agg = 0;

param.l_dense = [3, 3, 3]; % vector of "surplus" for dense grid
...
param.min = [param.amin, param.kmin, param.tmin];
param.max = [param.amax, param.kmax, param.tmax];
