function G = gen_FD_dirichlet(G, BC, name)
...
for k = compute_dims
    ...
    elseif ismember(BC_right{k}, {'D'})
        DF_right = sparse(right_idx_bound, right_idx_bound, -1./right_dist(right_idx_bound), n_bound, n_bound, 2*n_bound);
    elseif ismember(BC_right{k}, {'D_birth'})
        DF_right = sparse([right_idx_bound, right_idx_bound], ...
                          [right_idx_bound, left_idx_bound], ...
                          [-1./right_dist(right_idx_bound), 1./right_dist(left_idx_bound)], ...
            n_bound, n_bound, 2*n_bound);
    elseif ismember(BC_right{k}, {'fxF=coef*fxx'})
        coef = f_bound_right{k}(bound_grid(left_idx_bound, :));
        coef1 = (1./right_dist + b2 .* coef) ./ (1./right_dist - c2 .* coef); % f_{J}
        coef2 = (a2 .* coef) ./ (1./right_dist - c2 .* coef);                 % f_{J-1}
        DF_right = sparse( ...
            [right_idx_bound; right_idx_bound; right_idx_bound], ...
            [right_idx_bound; left_neighbor_bound(right_idx_bound); right_idx_bound], ...
            [-1./right_dist(right_idx_bound), ...
            1./right_dist(right_idx_bound) .* coef2(right_idx_bound), ...
            1./right_dist(right_idx_bound) .* coef1(right_idx_bound)], ...
            n_bound, n_bound, 2*n_bound);
    end
    ...
    % Backward difference
    DB_boundary = sparse([right_idx_bound; right_idx_bound], ...
        [right_idx_bound; left_neighbor_bound(right_idx_bound)], ...
        [1./left_dist(right_idx_bound), -1./left_dist(right_idx_bound)], ...
        n_bound, n_bound, 2*n_bound);

    % Sparse operator
    DBH = bound_Ek * DB_boundary * bound_Hk * BH_grid_to_bound_comp / G.range(k);
    ...
    if ismember(BC_right{k}, {'0', 'VNF', 'D', 'D_birth'})
        DC_right = sparse( ...
            [right_idx_bound; right_idx_bound; right_idx_bound], ...
    ...
    elseif ismember(BC_right{k}, {'fxF=coef*fxx'})
        DC_right = sparse( ...
            [right_idx_bound; right_idx_bound; right_idx_bound; right_idx_bound], ...
            [left_neighbor_bound(right_idx_bound); right_idx_bound; left_neighbor_bound(right_idx_bound); right_idx_bound], ...
            [a1(right_idx_bound), b1(right_idx_bound), c1(right_idx_bound) .* coef2(right_idx_bound), c1(right_idx_bound) .* coef1(right_idx_bound)], ...
            n_bound, n_bound, 3*n_bound);
    end
    % Sparse operator
    ...
    if ismember(k, G.dxx_dims)
        ...
        elseif ismember(BC_right{k}, {'fxF=coef*fxx'})
            D2_right = sparse( ...
                [right_idx_bound; right_idx_bound; right_idx_bound; right_idx_bound], ...
                [left_neighbor_bound(right_idx_bound); right_idx_bound; left_neighbor_bound(right_idx_bound); right_idx_bound], ...
                [a2(right_idx_bound), b2(right_idx_bound), ...
                c2(right_idx_bound) .* coef2(right_idx_bound), ...
                c2(right_idx_bound) .* coef1(right_idx_bound)], ...
                n_bound, n_bound, 3*n_bound);
        end
    ...
    if strcmp(BC_right{k}, 'D')
        const_c_right = f_bound_right{k}(bound_grid(right_idx_bound, :));
        
        % VNF: fx(J) = f(J+1) / h  -  f(J) / h
        G.(['const_', name]).D1F{k}(right_idx_bound) = const_c_right * 1/right_offset;
    end
